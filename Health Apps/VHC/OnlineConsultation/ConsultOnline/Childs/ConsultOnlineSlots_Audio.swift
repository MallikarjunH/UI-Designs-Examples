//
//  ConsultOnlineSlots_Audio.swift
//  VidalHealth
//
...
class ConsultOnlineSlots_Audio: UIViewController,UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    @objc func preveousDateSelection(notification: Notification) {
        ...
        //show preveous slots
        print("Clicked on Preveous Date: Iam in Audio")
        if let slotsOfArray = notification.userInfo?["slots"] as? NSArray {
            
            // print("Slots of Audio Consult: \(slotsOfArray)")
        ...
        if GlobalVariables.sharedManager.slotsAvailableForAudioConsult == "y" {
    ...
    @objc func nextDateSelection(notification: Notification) {
        ...
        self.slotsArrayForTheDay = []
        //show next slots
        print("Clicked on Next Date: I am in Audio")
        if let slotsOfArray = notification.userInfo?["slots"] as? NSArray {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "TimeSelectionCollectionCell2Id", for: indexPath) as! TimeSelectionCollectionCell2
    ...
    @IBAction func bookAppointmentButtonClicked(_ sender: Any) {
        ...
        if  selectedSlotString != "0"
        {
            print("Clicked on book book appointment")
