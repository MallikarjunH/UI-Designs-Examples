...
class LipidProfileDetails: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.moveToLogDetailedView(notification:)), name: Notification.Name("selectedLogTabFromLipidProfile"), object: nil)
    }
    ...
    @objc func moveToLogDetailedView(notification: Notification) {
        ...
        let detailsVC = storyBoard.instantiateViewController(withIdentifier: "LipidProfileEditDetailsId") as? LipidProfileEditDetails
        self.navigationController?.pushViewController(detailsVC!, animated: true)
    }
    
    deinit
    {
        NotificationCenter.default.removeObserver(self, name: Notification.Name("selectedLogTabFromLipidProfile"), object: nil)
    }
