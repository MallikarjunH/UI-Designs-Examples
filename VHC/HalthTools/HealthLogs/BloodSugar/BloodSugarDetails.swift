...
class BloodSugarDetails: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.moveToLogDetailedView(notification:)), name: Notification.Name("selectedLogTabFromBloodSugar"), object: nil)
    }
    ...
    @objc func moveToLogDetailedView(notification: Notification) {
        ...
        let detailsVC = storyBoard.instantiateViewController(withIdentifier: "BloodSugarEditDetailsId") as? BloodSugarEditDetails
        self.navigationController?.pushViewController(detailsVC!, animated: true)
    }
    
    deinit
    {
        NotificationCenter.default.removeObserver(self, name: Notification.Name("selectedLogTabFromBloodSugar"), object: nil)
    }
