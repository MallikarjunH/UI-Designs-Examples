...
class BloodPressureDetails: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Do any additional setup after loading the view.
         NotificationCenter.default.addObserver(self, selector: #selector(self.moveToLogDetailedView(notification:)), name: Notification.Name("selectedLogTabFromBloodPressure"), object: nil)
    ...
    @objc func moveToLogDetailedView(notification: Notification) {
        ...
        let detailsVC = storyBoard.instantiateViewController(withIdentifier: "BloodPressureEditDetailsId") as? BloodPressureEditDetails
        self.navigationController?.pushViewController(detailsVC!, animated: true)
    }
    
    deinit
    {
        NotificationCenter.default.removeObserver(self, name: Notification.Name("selectedLogTabFromBloodPressure"), object: nil)
    }
    
    
    //MARK: Navigation and Botton Buttons
