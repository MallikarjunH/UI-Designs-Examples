//
//  HeightSelectionPopUpVC.swift
//  VidalHealth
//
//  Created by mallikarjun on 18/06/19.
...
class HeightSelectionPopUpVC: UIViewController,UITableViewDelegate, UITableViewDataSource {
   ...
   @IBOutlet  weak var maintableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
         ...
         let cell = tableView.dequeueReusableCell(withIdentifier: "HeightSelectionPopUpCellId", for: indexPath) as! HeightSelectionPopUpCell
